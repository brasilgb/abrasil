...
<div class="row">
    <div class="col-lg-6 col-xs-12">
        <div class="card bg-light mt-3 shadow-sm">
            ...
            <div
                class="card-body @if($agendas->where('status', 1)->count() > 5) table-overflow @else table-fixa @endif">
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="card bg-light mt-3 shadow-sm">
            ...
            <div class="card-body @if($ordens->where('status', 2)->count() > 5) table-overflow @else table-fixa @endif">
                <table class="table table-striped table-hover table-condensed">
                    <thead>
...
<div class="row">
    <div class="col-lg-6 col-xs-12">
        <div class="card bg-light mt-3 shadow-sm">
            ...
            <div class="card-body @if($ordens->where('status', 3)->count() > 5) table-overflow @else table-fixa @endif">
                <table class="table table-striped table-hover table-condensed">
                    <thead>
                        <tr class="table-secundary">
                            <th>#Ordem</th>
    ...
    <div class="col-lg-6 col-xs-12">
        <div class="card bg-light mt-3 shadow-sm">
            ...
            <div class="card-body @if($ordens->where('status', 5)->count() > 5) table-overflow @else table-fixa @endif">
                <table class="table table-striped table-hover table-condensed">
                    <thead>
                        <tr class="table-default">
                            <th>#Ordem</th>
