...
<div class="card bg-light">
    <div class="card-header clearfix">
        <a href="{{ route('usuarios.create') }}" class="btn btn-primary float-left"><i class="fa fa-plus"></i>
            Cadastrar</a>
        @if($term)
        <a href="{{ route('usuarios.index') }}" class="btn btn-default float-left"><i class="fa fa-angle-left"></i>
            Voltar</a>
        @endif
            ...
            <table class="table table-striped table-condensed">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button @if($usuario->funcao == 1) {{'disabled'}} @else {{''}} @endif  data-toggle="modal" onclick="deleteData({{$usuario->id_}})" data-target="#DeleteModal"
