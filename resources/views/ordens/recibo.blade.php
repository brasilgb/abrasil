...
<body>
    ...
    <div class="container" style="border-bottom: 1px dashed #555;padding-bottom: 10px;margin-bottom: 10px;">
        <table>
            <tr>
            ...
            <tr>
                <td colspan="2" style="padding: 5px 0 5px 5px;background-color: rgb(202, 202, 202)">Serviços solicitados:</td>
            </tr>
            <tr>
