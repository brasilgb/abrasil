    ...
    <div class="card bg-light shadow-sm">
        ...
        @foreach ($backups as $backup)
            ...
            <div class="card-body">
                ...
                <form action="{{ route('backups.update', [$backup->id_backup]) }}" method="POST"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for=""><i class="fa fa-asterisk text-danger small"></i>
                            Senha BD:</label>
                        <div class="col-sm-10">
                            <input id="" type="password" class="form-control" name="senha"
                                value="{{ old('senha', $backup->senha) }}">
                            @error('senha')
                                <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}
                                </div>
                            @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="" type="text" class="form-control" name="diretorio"
                                value="{{ old('diretorio', $backup->diretorio) }}">
                            @error('diretorio')
                                <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}
                                </div>
                            @enderror
