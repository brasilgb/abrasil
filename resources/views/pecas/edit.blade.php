            ...
            <form action="{{ route('pecas.update', ['peca' => $peca->id_peca]) }}" method="POST" autocomplete="off">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for=""><i class="fa fa-asterisk text-danger small"></i>
                        Peça:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="peca" value="{{ old('peca', $peca->peca) }}">
                        @error('peca')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control"
                            name="descricao">{{ old('descricao', $peca->descricao) }}</textarea>
                        @error('descricao')
                            <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for=""><i class="fa fa-asterisk text-danger small"></i>
                        Fabricante:</label>
                    <div class="col-sm-10">
                        <input id="" type="text" class="form-control" name="fabricante"
                            value="{{ old('fabricante', $peca->fabricante) }}">
                        @error('fabricante')
                            <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input id="" type="text" class="form-control" name="quantidade"
                            value="{{ old('quantidade', $peca->quantidade) }}">
                        @error('quantidade')
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for=""><i class="fa fa-asterisk text-danger small"></i>
                        Valor:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="valor" value="{{ old('valor', $peca->valor) }}">
                        @error('valor')
                            <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}
                            </div>
                        @enderror
                    ...
                    <div class="col-sm-10">
                        <select class="custom-select my-1 mr-sm-2" name="situacao">
                            @foreach ($situacao as $key => $value)
                                <option value="{{ $key }}"
                                    {{ old('situacao', $peca->situacao) == $key ? 'selected' : '' }}>
                                    {{ $value }}</option>
                            @endforeach
                        </select>
                        @error('situacao')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control"
                            name="observacoes">{{ old('observacoes', $peca->observacoes) }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
