                ...
                <div class="alert alert-info">
                    <p><i class="fa fa-hand-point-right"></i> As etiquetas impressas referem-se ao padrão A4048 - A4 6x16.
                        <a href="http://textolivre.org/aplicacoes/linhadotexto/modulos/ajuda/etiquetas.php?op=abrir&cod_etiqueta=12"
                            target="_blank" title="Etiquetas">Veja sobre etiquetas</a>.</p>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <input id="" type="text" name="valinicial" class="valinicial form-control rounded-0 col-xs-4"
                                value="{{ $etiquetainicial['id_ordem'] + 1 }}">

                            <span class="input-group-text bg-gray" style="border-radius: 0!important;">Até</span>
                            <input id="" type="text" name="valfinal" class="valfinal form-control  rounded-0 col-xs-4"
                                value="{{ $etiquetainicial['id_ordem'] + 96 }}">

                            <div class="input-group-append">
                                <button class="geraetiqueta rounded-right btn btn-primary" type="submit"><i
                                        class="fa fa-tag"></i>
                                    Gerar</button>
                            </div>
                        </div>
